...
export default function ClienteLoginPage() {
  return (
    ...
    >
      ...
      >
        {/* gold corner accents — same language as hero card */}
        ...
        <h1 className="font-display-kinetic--tight mt-4 text-3xl uppercase leading-tight">Acceso de cliente</h1>
        <p className="mt-3 text-sm leading-6" style={{ color: "var(--text-secondary)" }}>
          Historial de pedidos, facturas, cotizaciones, vehículos y referidos en un mismo panel.
        </p>
        <div className="mt-8">
          <Suspense>
        ...
        <div className="mt-6 text-center">
          <Link
            href="/login/cliente/recuperar"
            className="font-mono-tech text-[10px] hover:opacity-80"
